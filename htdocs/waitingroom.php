...
<style>
    ...
    <div class="title"<?php echo isset($parameters["type"])?' type="'.$parameters["type"].'"':'' ?><?php echo isset($parameters["text"])?' text="'.$parameters["text"].'"':'' ?>><?php echo $parameters["filename"]?></div>
